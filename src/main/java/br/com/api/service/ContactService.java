...
public class ContactService {
	...
	public ContactModel contactSave(ContactModel contactModel) {
	...
	public ContactModel updateContact(ContactModel contactModel) throws Exception {
		Optional<ContactModel> cmo = this.contactRepository.findById(contactModel.getId());
		if (cmo.isPresent()) {
			ContactModel cm = cmo.get();
	...
	public void contactDelete(Long contactId) throws Exception {
		Optional<ContactModel> contact = this.contactRepository.findById(contactId);
